    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'Regular User'), ('artist', 'Artist'), ('venue_owner', 'Venue Owner'), ('admin', 'Administrator')], default='user', max_length=15)),
                ...
                ('telephone', models.CharField(max_length=15, validators=[django.core.validators.RegexValidator(message="Phone number must be entered in the format: '+2348031234567'.", regex='^\\+?234?\\d{9,15}$')])),
